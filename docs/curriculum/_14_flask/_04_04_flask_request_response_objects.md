...
metadata:
  ...
  lesson_slug: "flask-request-response-objects"
  lesson_title: "Lesson 2.2 HTTP Methods, Request Object Inspection, & Response Formatting"
  sort_order: 202
...
prerequisites:
  required_lesson_ids:
    - "FLK-MOD02-LES01"
  required_skills:
    - "Flask Routing System & Dynamic Parameters"

skills_acquired:
  - "Configuring HTTP Methods (`methods=['GET', 'POST']`)"
  - "Inspecting Incoming Request Data (`request.args`, `request.json`, `request.form`)"
  - "Custom Response Formatting (`make_response()`, `jsonify()`)"
  - "Request Lifecycle Hooks (`@app.before_request`, `@app.after_request`)"
...
seo_and_social:
  meta_title: "Flask Request & Response Objects: request.json, jsonify & Request Hooks"
  meta_description: "Master Flask Request and Response objects: methods=['POST'], inspecting request.json/args/form, make_response(), jsonify(), and @before_request hooks."
  keywords: ["Flask Request Object", "request.json", "jsonify", "make_response", "before_request", "Flask HTTP Methods"]
