...
metadata:
  ...
  lesson_slug: "fetch-api-and-http-network-requests"
  lesson_title: "Lesson 9.1 Fetch API & HTTP Network Requests"
  sort_order: 901
...
skills_acquired:
  - "Fetch API Requests (`fetch(url, options)`)"
  - "HTTP Methods (GET, POST, PUT, DELETE, PATCH)"
  - "Configuring Headers (`Content-Type: application/json`)"
  - "Handling HTTP Error Status Codes (`response.ok`)"
  - "Aborting Requests via `AbortController`"
...
seo_and_social:
  meta_title: "JavaScript Fetch API: GET, POST, JSON Parsing, response.ok & AbortController"
  meta_description: "Master JavaScript Fetch API: making HTTP network requests, setting headers, checking response.ok error status, parsing JSON, and request cancellation with AbortController."
  keywords: ["Fetch API", "JavaScript HTTP", "response.ok", "AbortController", "JSON POST request", "Async Fetch"]
...
# Lesson 9.1 Fetch API & HTTP Network Requests
