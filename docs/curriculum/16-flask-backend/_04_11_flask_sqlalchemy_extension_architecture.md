...
metadata:
  ...
  lesson_slug: "flask-sqlalchemy-extension-architecture"
  lesson_title: "Lesson 6.1 Flask-SQLAlchemy Extension Architecture"
  sort_order: 601
...
prerequisites:
  required_lesson_ids:
    - "FLK-MOD05-LES02"
  required_skills:
    - "Flask Application Factory & SQL Database Fundamentals"

skills_acquired:
  - "Integrating Flask-SQLAlchemy (`db = SQLAlchemy()`)"
  - "Configuring Database Connection URIs (`SQLALCHEMY_DATABASE_URI`)"
  - "Initializing Extensions via Application Factory (`db.init_app(app)`)"
  - "Managing Scoped Database Sessions (`db.session`)"
...
seo_and_social:
  meta_title: "Flask-SQLAlchemy ORM Architecture: Database URIs, db.init_app & Sessions"
  meta_description: "Master Flask-SQLAlchemy ORM Architecture: database URIs (SQLite, MySQL, PostgreSQL), db.init_app factory initialization, and db.session transaction management."
  keywords: ["Flask-SQLAlchemy", "SQLAlchemy ORM", "SQLALCHEMY_DATABASE_URI", "db.init_app", "db.session", "Python Database"]
