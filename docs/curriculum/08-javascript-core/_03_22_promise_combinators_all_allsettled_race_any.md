...
schema_version: "2.0"
metadata:
  lesson_id: "JS-MOD06-LES04"
  course_slug: "course-03-javascript"
  course_title: "Course 3: JavaScript & ES6+"
  module_slug: "mod-06-async-promises-await"
  module_title: "Module 6 - Asynchronous JavaScript, Promises, & Async/Await"
  lesson_slug: "promise-combinators-all-allsettled-race-any"
  lesson_title: "Lesson 6.4 Promise Combinators (all, allSettled, race, any)"
  sort_order: 604
...
prerequisites:
  required_lesson_ids:
    - "JS-MOD06-LES03"
  required_skills:
    - "Async/Await & ES6 Promises Architecture"

skills_acquired:
  - "`Promise.all()` Fail-Fast Parallel Execution"
  - "`Promise.allSettled()` Complete Batch Inspection (`status: 'fulfilled' | 'rejected'`)"
  - "`Promise.race()` First Settled Winner (Timeout Pattern)"
  - "`Promise.any()` First Fulfilled Winner & AggregateError Handling"
...
seo_and_social:
  meta_title: "JavaScript Promise Combinators: Promise.all, allSettled, race & any"
  meta_description: "Master JavaScript Promise Combinators: Promise.all fail-fast parallel execution, Promise.allSettled batch evaluation, Promise.race timeouts, and Promise.any."
  keywords: ["Promise Combinators", "Promise.all", "Promise.allSettled", "Promise.race", "Promise.any", "Parallel Async"]
...
# Lesson 6.4 Promise Combinators (`all`, `allSettled`, `race`, `any`)
