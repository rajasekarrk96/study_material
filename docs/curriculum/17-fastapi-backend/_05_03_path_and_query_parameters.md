...
metadata:
  ...
  lesson_slug: "path-and-query-parameters"
  lesson_title: "Lesson 2.1 Path Parameters, Query Strings, & Type Annotations"
  sort_order: 201
...
prerequisites:
  required_lesson_ids:
    - "FAP-MOD01-LES02"
  required_skills:
    - "FastAPI Basics & Routing"

skills_acquired:
  - "Declaring Path Parameters (`/items/{item_id}`)"
  - "Declaring Query String Parameters (`?page=1&limit=10`)"
  - "Automatic Python Type Parsing (`int`, `float`, `bool`, `UUID`)"
  - "Validation Rules using `Path()` and `Query()` helpers"
...
seo_and_social:
  meta_title: "FastAPI Parameters: Path Variables, Query Strings, Type Casting & Path/Query Helpers"
  meta_description: "Master FastAPI Parameters: path parameters, query string parameters, automatic type casting, optional parameters, and validation constraints using Path() and Query()."
  keywords: ["FastAPI Path Parameters", "Query Parameters", "FastAPI Query", "Path Validation", "Type Casting", "Python Type Hints"]
