...
metadata:
  ...
  lesson_slug: "sqlalchemy-20-async-engine-and-asyncpg"
  lesson_title: "Lesson 4.1 SQLAlchemy 2.0 Async Engine & asyncpg"
  sort_order: 401
...
prerequisites:
  required_lesson_ids:
    - "FAP-MOD03-LES02"
  required_skills:
    - "FastAPI Yield Dependencies & Async Python"

skills_acquired:
  - "Configuring SQLAlchemy 2.0 Async Engine (`create_async_engine`)"
  - "Using High-Performance Async Drivers (`asyncpg` for PostgreSQL, `aiosqlite` for SQLite)"
  - "Creating `async_sessionmaker` Factory"
  - "Injecting `AsyncSession` via FastAPI Yield Dependencies"
...
seo_and_social:
  meta_title: "FastAPI Async Database: SQLAlchemy 2.0, asyncpg, create_async_engine & AsyncSession"
  meta_description: "Master Asynchronous Database Integration in FastAPI: SQLAlchemy 2.0 async engine, asyncpg driver for PostgreSQL, aiosqlite, async_sessionmaker, and Yield Dependencies."
  keywords: ["SQLAlchemy 2.0 Async", "asyncpg", "create_async_engine", "AsyncSession", "FastAPI Async DB", "aiosqlite"]
