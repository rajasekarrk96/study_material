...
schema_version: "2.0"
metadata:
  lesson_id: "FAP-MOD10-LES02"
  course_slug: "course-05-fastapi"
  course_title: "Course 5: FastAPI High-Performance Microservices"
  module_slug: "mod-10-testing-deployment"
  module_title: "Module 10 - Testing & Production Deployment"
  lesson_slug: "production-deployment-gunicorn-uvicorn-docker"
  lesson_title: "Lesson 10.2 Production Deployment with Gunicorn Uvicorn Workers & Docker"
  sort_order: 1002
...
prerequisites:
  required_lesson_ids:
    - "FAP-MOD10-LES01"
  required_skills:
    - "FastAPI Core Architecture & Environment Settings"

skills_acquired:
  - "Configuring Gunicorn with Uvicorn Worker Class (`uvicorn.workers.UvicornWorker`)"
  - "Writing Production Multi-Stage Dockerfiles"
  - "Orchestrating FastAPI & PostgreSQL with Docker Compose"
  - "Production Performance Tuning & Worker Process Scaling"
...
seo_and_social:
  meta_title: "FastAPI Production Deployment: Gunicorn Uvicorn Workers, Docker & Nginx"
  meta_description: "Master Production Deployment of FastAPI: Gunicorn process manager with UvicornWorker, multi-stage Dockerfile containerization, and Docker Compose orchestration."
  keywords: ["FastAPI Production Deployment", "Gunicorn UvicornWorker", "FastAPI Docker", "Dockerfile", "Docker Compose", "ASGI Deployment"]
