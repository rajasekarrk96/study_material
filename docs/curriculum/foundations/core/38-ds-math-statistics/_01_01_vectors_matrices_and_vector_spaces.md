...
metadata:
  ...
  lesson_slug: "vectors-matrices-and-vector-spaces"
  lesson_title: "Lesson 1.1.1 Vectors, Matrices, & Vector Spaces"
  sort_order: 101
...
prerequisites:
  required_lesson_ids:
    ...
    - "Python.Functions"
  required_skills:
    - "Python Lists & Numerical Functions"

skills_acquired:
  - "Vector Operations (Addition, Scalar Multiplication, Dot Product, Cross Product)"
  - "Matrix Multiplication Geometry & Transposition Rules"
  - "Vector Spaces, Subspaces, and Basis Systems"
  - "Linear Independence & Span Analysis"
...
seo_and_social:
  meta_title: "Linear Algebra: Vectors, Matrix Multiplication & Vector Spaces for ML"
  meta_description: "Master linear algebra foundations for machine learning: vector dot products, matrix multiplication geometry, linear independence, span, and vector spaces."
  keywords: ["Linear Algebra", "Vector Space", "Dot Product", "Matrix Multiplication", "Linear Independence", "Span", "Machine Learning Math"]
...
# Lesson 1.1.1 Vectors, Matrices, & Vector Spaces
