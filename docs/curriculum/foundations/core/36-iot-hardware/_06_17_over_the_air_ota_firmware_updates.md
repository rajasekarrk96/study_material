...
metadata:
  ...
  lesson_slug: "over-the-air-ota-firmware-updates"
  lesson_title: "Lesson 8.1 Over-The-Air (OTA) Firmware Updates"
  sort_order: 801
...
prerequisites:
  required_lesson_ids:
    - "IOT-MOD07-LES02"
  required_skills:
    - "ESP32 Wi-Fi Station Networking & PlatformIO Build System"

skills_acquired:
  - "Understanding Dual-Bank OTA Partition Layout (`ota_0` vs `ota_1`)"
  - "Configuring `ArduinoOTA` Wireless Updates"
  - "HTTP/HTTPS Remote Firmware Binary Updates (`ESP32httpUpdate`)"
  - "Handling Rollback on Failed Firmware Flashes"
...
seo_and_social:
  meta_title: "ESP32 OTA Updates: ArduinoOTA, HTTPhttpUpdate & Dual-Bank Partition"
  meta_description: "Master ESP32 Over-The-Air (OTA) Firmware Updates: dual-bank partition layout (ota_0 / ota_1), ArduinoOTA setup, HTTP remote binary downloads, and rollback safety."
  keywords: ["ESP32 OTA", "ArduinoOTA", "ESP32httpUpdate", "OTA Partition Layout", "ota_0 ota_1", "Remote Firmware Upgrade"]
