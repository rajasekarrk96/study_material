...
metadata:
  ...
  lesson_slug: "javascript-unit-testing-with-vitest"
  lesson_title: "Lesson 12.4 JavaScript Unit Testing with Vitest"
  sort_order: 1204
...
prerequisites:
  required_lesson_ids:
    - "JS-MOD12-LES03"
  required_skills:
    - "JavaScript Functions & ES6 Modules"

skills_acquired:
  - "AAA Testing Pattern (Arrange, Act, Assert)"
  - "Vitest Test Suite Structure (`describe`, `it`, `expect`)"
  - "Assertion Matchers (`toBe`, `toEqual`, `toThrow`)"
  - "Function Mocking & Spies via `vi.fn()` and `vi.spyOn()`"
...
seo_and_social:
  meta_title: "JavaScript Unit Testing: Vitest, TDD, AAA Pattern, Mocks & Spies"
  meta_description: "Master JavaScript Unit Testing with Vitest: AAA pattern (Arrange, Act, Assert), describe/it test suites, expect matchers, and function mocking with vi.fn()."
  keywords: ["Vitest", "JavaScript Unit Testing", "AAA Pattern", "TDD", "vi.fn()", "Test Suites", "Mocks and Spies"]
