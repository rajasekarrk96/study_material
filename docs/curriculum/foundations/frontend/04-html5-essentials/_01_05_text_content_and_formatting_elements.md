...
schema_version: "2.0"
metadata:
  lesson_id: "HTML5-MOD02-LES02"
  course_slug: "course-01-html5"
  course_title: "Course 1: HTML5"
  module_slug: "mod-02-syntax-text-hyperlinks"
  module_title: "Module 2 - HTML Syntax, Text Formatting, & Hyperlinks"
  lesson_slug: "text-content-and-formatting-elements"
  lesson_title: "Lesson 2.2 Text Content & Formatting Elements"
  sort_order: 202
...
prerequisites:
  required_lesson_ids:
    - "HTML5-MOD02-LES01"
  required_skills:
    - "HTML Element Classification & Tag Syntax"

skills_acquired:
  - "Heading Hierarchy (`<h1>` to `<h6>`) Architectural Structuring"
  - "Semantic vs Presentational Formatting (`<strong>`/`<em>` vs `<b>`/`<i>`)"
  - "Computer Code & Technical Markup (`<code>`, `<pre>`, `<kbd>`, `<samp>`, `<var>`)"
  - "Citations & Quotations Markup (`<blockquote>`, `<q>`, `<cite>`, `<abbr>`)"
  - "Subscripts, Superscripts, Insertions, Deletions Usage"
...
seo_and_social:
  meta_title: "HTML Text Content & Formatting Elements: Semantics, Code & Headings"
  meta_description: "Master HTML heading hierarchy, paragraph rules, semantic formatting, computer code tags, quotations, citations, and bidirectional text."
  keywords: ["HTML Headings", "Semantic Text", "strong vs b", "em vs i", "pre code", "kbd", "blockquote", "abbr", "bdo bdi"]
