...
metadata:
  ...
  lesson_slug: "media-queries"
  lesson_title: "Lesson 6.2 Media Queries"
  sort_order: 602
...
skills_acquired:
  - "Media Types (`screen`, `print`) & Media Feature Queries"
  - "Modern Media Query Range Syntax (`(600px <= width <= 1024px)`)"
  - "User Preference Detection (`prefers-color-scheme: dark`)"
  - "Accessibility Motion Control (`prefers-reduced-motion: reduce`)"
...
seo_and_social:
  meta_title: "CSS3 Media Queries: Range Syntax, Dark Mode & prefers-reduced-motion"
  meta_description: "Master CSS3 Media Queries Level 4: modern range syntax (600px <= width <= 1024px), prefers-color-scheme dark mode, prefers-reduced-motion, and print styles."
  keywords: ["Media Queries", "prefers-color-scheme", "prefers-reduced-motion", "Range Syntax", "print stylesheet", "CSS Breakpoints"]
