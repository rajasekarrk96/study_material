...
metadata:
  ...
  lesson_slug: "asgi-architecture-uvicorn-and-fastapi-basics"
  lesson_title: "Lesson 1.1 Async Python, ASGI Architecture, & Uvicorn Basics"
  sort_order: 101
...
prerequisites:
  required_lesson_ids:
    - "FLK-MOD12-LES02"
  required_skills:
    - "Python 3.12+ Async/Await Basics & HTTP Fundamentals"

skills_acquired:
  - "Understanding ASGI (Asynchronous Server Gateway Interface) Architecture"
  - "Contrasting WSGI vs ASGI Performance"
  - "Executing Uvicorn Server (`uvicorn app:app --reload`)"
  - "Writing Asynchronous Route Handlers (`async def`)"
...
seo_and_social:
  meta_title: "FastAPI Basics: ASGI Architecture, Uvicorn & Async Route Handlers"
  meta_description: "Master FastAPI Core Architecture: ASGI specification vs WSGI, Uvicorn server execution, async def view functions, and asynchronous concurrency."
  keywords: ["FastAPI Basics", "ASGI Architecture", "Uvicorn", "async def", "Python Async", "FastAPI Performance"]
...
> **Source**: `_02_01_REST_API_Design_and_Constraints_Notes.md` (from backend concepts archive)
