...
metadata:
  ...
  lesson_slug: "async-testing-with-pytest-and-httpx"
  lesson_title: "Lesson 10.1 Async Testing with Pytest & httpx.AsyncClient"
  sort_order: 1001
...
prerequisites:
  required_lesson_ids:
    - "FAP-MOD09-LES02"
  required_skills:
    - "FastAPI Async Route Handlers & Pytest Basics"

skills_acquired:
  - "Configuring Pytest for Async Testing (`pytest-asyncio`)"
  - "Utilizing `httpx.AsyncClient` for In-Memory Async Requests"
  - "Testing Async FastAPI Endpoints (`@pytest.mark.asyncio`)"
  - "Overriding Async Database Session Dependencies"
...
seo_and_social:
  meta_title: "FastAPI Async Testing: Pytest, httpx.AsyncClient & pytest-asyncio"
  meta_description: "Master Asynchronous Testing in FastAPI: pytest-asyncio integration, httpx.AsyncClient for in-memory HTTP testing, @pytest.mark.asyncio, and dependency overrides."
  keywords: ["FastAPI Async Testing", "pytest-asyncio", "httpx.AsyncClient", "AsyncClient", "FastAPI Pytest", "In-Memory Test"]
