...
schema_version: "2.0"
metadata:
  lesson_id: "FAP-MOD05-LES01"
  course_slug: "course-05-fastapi"
  course_title: "Course 5: FastAPI High-Performance Microservices"
  module_slug: "mod-05-security-authentication"
  module_title: "Module 5 - Security & Authentication"
  lesson_slug: "oauth2-password-bearer-and-hashing"
  lesson_title: "Lesson 5.1 OAuth2 Password Bearer & Password Hashing"
  sort_order: 501
...
skills_acquired:
  - "Integrating OAuth2 Password Bearer Specification (`OAuth2PasswordBearer`)"
  - "Parsing Form Login Submissions (`OAuth2PasswordRequestForm`)"
  - "Hashing Passwords with Passlib & Bcrypt (`CryptContext`)"
  - "Enabling Interactive Swagger UI Authentication Authorization Button"
...
seo_and_social:
  meta_title: "FastAPI Security: OAuth2PasswordBearer, Passlib Bcrypt & Swagger Auth"
  meta_description: "Master FastAPI Security: OAuth2 Password Bearer specification, OAuth2PasswordRequestForm, password hashing using Passlib with Bcrypt, and Swagger UI Authorize button."
  keywords: ["FastAPI OAuth2", "OAuth2PasswordBearer", "Passlib Bcrypt", "OAuth2PasswordRequestForm", "FastAPI Security", "Swagger Auth Button"]
