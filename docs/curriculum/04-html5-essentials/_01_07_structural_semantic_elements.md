...
metadata:
  ...
  lesson_slug: "structural-semantic-elements"
  lesson_title: "Lesson 3.1 Structural Semantic Elements"
  sort_order: 301
...
prerequisites:
  required_lesson_ids:
    - "HTML5-MOD02-LES02"
  required_skills:
    - "Heading Hierarchy & Text Formatting"

skills_acquired:
  - "Semantic Layout Architecture Design"
  - "Landmark Element Selection (`<header>`, `<nav>`, `<main>`, `<footer>`)"
  - "Content Sectioning (`<article>` vs `<section>` vs `<aside>`)"
  - "Native Interactive Components (`<details>`, `<dialog>`)"
  - "Machine-Readable Time & Date Markup (`<time>`)"
...
seo_and_social:
  meta_title: "Semantic HTML5 Elements: Structural Landmarks, Layout & Dialogs"
  meta_description: "Master HTML5 semantic elements: header, nav, main, article, section, aside, footer, figure, details/summary, native dialog, and time markup."
  keywords: ["Semantic HTML5", "Landmarks", "header nav main footer", "article vs section", "aside", "details summary", "dialog element", "time tag"]
