...
metadata:
  ...
  lesson_slug: "html-standards-and-document-structure"
  lesson_title: "Lesson 1.3 HTML Standards & Document Structure"
  sort_order: 103
...
prerequisites:
  required_lesson_ids:
    ...
    - "HTML5-MOD01-LES02"
  required_skills:
    - "Browser Rendering Engine Lifecycle"

skills_acquired:
  - "Valid HTML5 Boilerplate Construction"
  - "Standards vs Quirks Mode Configuration"
  - "UTF-8 Character Encoding Implementation"
  - "Mobile Viewport Meta Configuration"
  - "Open Graph & Social Media Metadata Integration"
...
seo_and_social:
  meta_title: "HTML Standards & Document Structure: DOCTYPE, Meta Tags & Open Graph"
  meta_description: "Master HTML5 standards, WHATWG living specs, DOCTYPE declarations, UTF-8 encodings, viewport configuration, and Open Graph metadata."
  keywords: ["HTML5", "DOCTYPE", "WHATWG", "W3C", "UTF-8", "Viewport", "Open Graph", "SEO Meta Tags"]
