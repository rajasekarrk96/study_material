...
metadata:
  ...
  lesson_slug: "form-architecture-and-submissions"
  lesson_title: "Lesson 5.1 Form Architecture & Submissions"
  sort_order: 501
...
skills_acquired:
  - "Form Element (`<form>`) Configuration"
  - "Action URL & Target Routing"
  - "HTTP Method Selection for Forms (GET vs POST)"
  - "Form Enctype Payload Selection (`urlencoded` vs `multipart/form-data`)"
  - "Autocomplete & Novalidate Attribute Management"
...
seo_and_social:
  meta_title: "HTML5 Form Architecture: Submissions, HTTP Methods & Encoding Types"
  meta_description: "Master HTML5 forms: action, method (GET vs POST), encoding types (urlencoded, multipart/form-data), autocomplete, and novalidate attributes."
  keywords: ["HTML Forms", "form tag", "action method", "GET vs POST", "enctype", "multipart/form-data", "urlencoded", "novalidate"]
