...
metadata:
  ...
  lesson_slug: "html-syntax-rules-and-element-classification"
  lesson_title: "Lesson 2.1 Syntax Rules & Element Classification"
  sort_order: 201
...
skills_acquired:
  - "HTML Tag & Attribute Syntax Rules"
  - "Void (Self-Closing) Element Identification"
  - "Global vs Custom Data (`data-*`) Attributes Usage"
  - "Block-Level vs Inline-Level Display Classification"
  - "HTML Entity Encoding & Escaping Security Rules"
  - "DOM Element Nesting Validation"
...
seo_and_social:
  meta_title: "HTML Syntax Rules, Element Types & Entity Encoding Masterclass"
  meta_description: "Master HTML tag syntax, void elements, global attributes, data-* attributes, block vs inline display types, nesting rules, and HTML entity escaping."
  keywords: ["HTML Syntax", "Void Elements", "Block vs Inline", "Global Attributes", "data-* attributes", "HTML Entities", "Escaping"]
