...
#### 1.1. Module 1 — Core Concepts and Workflows

1. **Lesson 1.4 Modern C23 Features (`constexpr`, `typeof`, `auto`)**
...
#### 1.2. Module 2 — Introduction & Basics

1. **Introduction to C: History, Setup & Hello World**
    1. Topics Covered
...
2. **C Compilation Lifecycle & GCC Pipeline**
    1. Topics Covered
    2. Definitions & Core Concepts
    3. Practical Code Examples
...
#### 1.3. Module 3 — C Fundamentals

1. **C Introduction and Toolchain**
    1. What is C?
    2. Why Learn C?
    3. Toolchain
...
#### 1.4. Module 4 — Memory and Data Structures

1. **Arrays and Multidimensional Arrays**
    1. Arrays in C
    2. D Arrays
    3. Array Decay and Function Parameters
    4. Lab Exercise
2. **Strings in C**
    1. C Strings
    ...
    3. Reading Strings
    4. Lab Exercise
3. **Pointers Fundamentals**
    1. What is a Pointer?
    2. Pointer Sizes and Types
    3. Null and Uninitialized Pointers
    4. const and Pointers
    5. Pointer Arithmetic
    6. Lab Exercise
4. **Pointers and Arrays**
    1. Array-Pointer Equivalence
    2. Function Pointers
    3. Pointer to Pointer (double pointer)
    4. Array of Strings
    5. Lab Exercise

#### 1.5. Module 5 — Advanced C
...
#### 1.6. Module 6 — Systems Programming
...
3. **C for Embedded Systems**
    1. Embedded C Concepts
    2. Bit Manipulation
    3. Fixed-Width Types (stdint.h)
    4. Memory-Mapped I/O Structure
    5. Lab Exercise
4. **Debugging and Best Practices**
    ...
    5. Common C Bugs Checklist
    6. Lab Exercise

### 2. Cpp

#### 2.1. Module 1 — C++ Fundamentals

1. **C++ Overview and Setup**
    1. What is C++?
    2. Standards Timeline
    3. Setup
    4. Hello World
    5. RAII Principle
    6. Lab Exercise
2. **References and Value Types**
    1. References
...
#### 2.2. Module 2 — Modern Memory Safety & Smart Pointers

1. **Lesson 2.4 C++ Smart Pointers & RAII Memory Safety**
    1. Overview & Learning Objectives
        - Learning Objectives
    2. Environment & Prerequisites
    3. Theoretical Foundations
...
#### 2.3. Module 3 — Object-Oriented C++
...
2. **Operator Overloading**
    ...
    2. Subscript and Call Operators
    3. Lab Exercise
3. **Inheritance and Polymorphism**
    1. Virtual Functions and Polymorphism
    2. dynamic_cast and RTTI
    3. final and override
    4. Lab Exercise

#### 2.4. Module 4 — Modern C++ Memory
...
2. **STL Containers and Algorithms**
    1. Key STL Containers
    2. Algorithms
    3. Ranges (C++20)
    4. Lab Exercise

#### 2.5. Module 5 — Modern C++

1. **C++11 to C++23 Features**
    1. C++11 Essentials
    2. C++17 Features
    3. C++20 Features
    4. C++23 Features
...
2. **Concurrency in C++**
    ...
    6. Lab Exercise
3. **C++ for Embedded and Performance**
    1. Embedded C++ Constraints
    2. Compile Options for Embedded
    3. Stack/Static Allocation
    4. constexpr for Compile-Time Tables
    5. Performance Profiling
    6. Lab Exercise

#### 2.6. Module 6 — Core Concepts and Workflows

1. **Transition to C++: Namespaces & Streams**
    1. Topics Covered
    2. Definitions & Core Concepts
    3. Practical Code Examples
...
2. **Classes, Objects & Constructor Overloading**
    1. Topics Covered
    2. Definitions & Core Concepts
    3. Practical Code Examples
...
#### 3.1. Module 1 — Java Fundamentals
...
#### 3.2. Module 2 — Modern Class Types & Object-Oriented Java
...
#### 3.3. Module 3 — Object-Oriented Programming
...
#### 3.4. Module 4 — Collections & Stream API
...
#### 3.5. Module 5 — Collections and Generics
...
#### 3.6. Module 6 — High-Concurrency Virtual Threads & Project Loom
...
#### 3.7. Module 7 — Exceptions and I/O
...
### 5. Advanced Python & Professional Practices

#### 5.1. Module 1 — Python Internals
...
#### 5.2. Module 2 — Advanced Object-Oriented Python
...
#### 5.3. Module 3 — Functional Programming & Metaprogramming
...
#### 5.4. Module 4 — Functional Programming
...
#### 5.6. Module 6 — Memory Management & Context Managers
...
#### 5.7. Module 7 — Concurrency & Async Programming
...
#### 5.9. Module 9 — Python Packaging and Tools
...
#### 5.10. Module 10 — Packaging & Testing Frameworks
...
#### 5.11. Module 11 — Advanced Patterns
...
#### 5.12. Module 12 — Design Patterns in Python
...
#### 6.1. Module 1 — Algorithm Analysis & Basics
...
#### 6.2. Module 2 — Complexity Analysis
...
#### 6.3. Module 3 — Linear Data Structures
...
#### 6.4. Module 4 — Linear Data Structures
...
#### 6.5. Module 5 — Sorting & Searching
...
#### 6.6. Module 6 — Non-Linear Data Structures
...
#### 6.7. Module 7 — Searching and Sorting
...
#### 6.8. Module 8 — Non-Linear Data Structures
...
#### 6.10. Module 10 — Graphs & Dynamic Programming
...
#### 9.1. Module 1 — Grid System and Layout
...
#### 9.2. Module 2 — Typography and Utilities
...
#### 9.4. Module 4 — Advanced Layout and Customization
...
#### 10.1. Module 1 — Language Architecture, Engine, & Execution Mechanics
...
#### 10.2. Module 2 — Variables, Data Types, & Operators
...
#### 10.3. Module 3 — Control Flow, Loops, & Iteration Protocols
...
#### 10.4. Module 4 — Functions, Scope, & Closures
...
#### 10.5. Module 5 — Objects, Arrays, & Data Structures
...
#### 10.6. Module 6 — Asynchronous JavaScript, Promises, & Async/Await
...
#### 10.7. Module 7 — Object-Oriented Programming, Classes, & Prototypes
...
#### 10.8. Module 8 — Document Object Model (DOM) Manipulation & Events
...
#### 10.9. Module 9 — Web APIs, Client-Side Storage, & Network Requests
...
#### 10.10. Module 10 — ES6+ Modules, Tooling, & Bundlers
...
#### 10.11. Module 11 — Browser Performance, Security, & Optimization
...
#### 10.12. Module 12 — Advanced Patterns, Meta-Programming, & Testing
...
#### 13.1. Module 1 — Setup and TSQL Fundamentals
...
#### 13.2. Module 2 — Retrieval and Filtering
...
#### 13.3. Module 3 — Aggregations and Window Functions
...
#### 13.4. Module 4 — Indexes and Optimization
...
#### 13.5. Module 5 — Programmability and Transactions
...
#### 13.6. Module 6 — Administration and Security
...
#### 13.7. Module 7 — Enterprise Architecture
...
#### 14.1. Module 1 — Selenium 4.x Architecture & Locators
...
#### 14.2. Module 2 — Selenium Fundamentals
...
#### 14.3. Module 3 — Waits and Synchronisation
...
#### 14.4. Module 4 — Advanced Interactions
...
#### 14.5. Module 5 — Test Architecture
...
#### 14.6. Module 6 — Testing Framework Integration
...
#### 15.1. Module 1 — Selenium Fundamentals
