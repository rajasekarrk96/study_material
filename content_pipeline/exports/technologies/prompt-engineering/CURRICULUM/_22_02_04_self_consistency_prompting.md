...
duration_minutes: 60
tags: ["self-consistency", "majority-voting", "sampling"]
prerequisites: []
lab_required: true
---
...
## Overview of Self-Consistency Prompting

In this lesson, you will master **Self-Consistency Prompting** as part of Module 2: Core Prompting Techniques in Prompt Engineering.
