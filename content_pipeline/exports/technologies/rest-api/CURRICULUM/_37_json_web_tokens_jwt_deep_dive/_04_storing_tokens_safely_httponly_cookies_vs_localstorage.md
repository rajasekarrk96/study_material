---
title: Storing Tokens Safely (HttpOnly Cookies vs LocalStorage)
module: JSON Web Tokens (JWT) Deep Dive
lesson: Storing Tokens Safely (HttpOnly Cookies vs LocalStorage)
lesson_number: 37.4
