---
title: HTTP Protocol Architecture & Verbs (GET, POST, PUT, DELETE, PATCH)
module: REST Principles & Standards
lesson: HTTP Protocol Architecture & Verbs (GET, POST, PUT, DELETE, PATCH)
lesson_number: 2.1
