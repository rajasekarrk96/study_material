# Referenced Courses: Python Full Stack Developer
...
| Javascript | `javascript` | `core` | `None` |
| Jquery | `jquery` | `core` | `None` |
| React.js Modern Frontend Development | `react` | `core` | `None` |
| MySQL | `mysql` | `core` | `None` |
| Mongodb | `mongodb` | `core` | `None` |
| Flask | `flask` | `core` | `None` |
