# Learning Path Sequence: QA Automation Engineer
...
7. **Playwright** (`playwright`) -- CORE (Automation)
8. **Postman / API Testing** (`postman`) -- CORE (API Testing)
9. **MySQL** (`mysql`) -- CORE (Database)
10. **Maven** (`maven`) -- CORE (Build)
11. **Jenkins** (`jenkins`) -- CORE (CI/CD)
