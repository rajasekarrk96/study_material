...
metadata:
  ...
  lesson_slug: "web-architecture-and-protocols"
  lesson_title: "Lesson 1.1 Web Architecture & Protocols"
  sort_order: 101
...
prerequisites:
  required_lesson_ids: []
  required_skills:
    - "Basic understanding of operating systems and internet concepts"

skills_acquired:
  - "Client-Server Request-Response Mechanics"
  - "HTTP/HTTPS Protocol Parsing & Header Analysis"
  - "HTTP Status Code Diagnostics"
  - "DNS Resolution Lifecycle Tracing"
  - "Web Server vs Application Server Differentiation"
...
seo_and_social:
  meta_title: "Web Architecture & Protocols: Client-Server, HTTP/HTTPS, DNS Deep Dive"
  meta_description: "Master client-server architecture, HTTP methods, status codes, DNS resolution, and web vs application servers for web and IoT engineering."
  keywords: ["HTTP", "HTTPS", "DNS", "Web Architecture", "Client Server", "REST API", "URI URL URN"]
