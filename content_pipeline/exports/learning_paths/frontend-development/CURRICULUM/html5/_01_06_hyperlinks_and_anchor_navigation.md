...
metadata:
  ...
  lesson_slug: "hyperlinks-and-anchor-navigation"
  lesson_title: "Lesson 2.3 Hyperlinks & Anchor Navigation"
  sort_order: 203
...
prerequisites:
  required_lesson_ids:
    - "HTML5-MOD02-LES01"
  required_skills:
    - "URI / URL Syntax Foundations"

skills_acquired:
  - "Anchor Element (`<a>`) Implementation"
  - "Absolute vs Relative Path Resolution"
  - "In-Page Fragment Identifier (`#anchor`) Jumping"
  - "Security Link Hardening (`rel='noopener noreferrer'`)"
  - "Non-HTML Protocols (`mailto:`, `tel:`, `sms:`)"
  - "Resource Download & Preloading (`download`, `preload`, `prefetch`)"
...
seo_and_social:
  meta_title: "HTML Hyperlinks & Anchor Navigation: Security, Protocols & Preloading"
  meta_description: "Master HTML anchor tags (<a>), absolute vs relative URLs, fragment jumpers, target security (rel='noopener'), mailto/tel protocols, and link preloading."
  keywords: ["HTML Anchor", "Hyperlinks", "Absolute vs Relative", "target=_blank", "rel=noopener", "mailto", "tel", "download attribute", "prefetch"]
