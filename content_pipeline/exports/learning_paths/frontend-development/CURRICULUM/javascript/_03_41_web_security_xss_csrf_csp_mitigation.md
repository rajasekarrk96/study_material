...
metadata:
  ...
  lesson_slug: "web-security-xss-csrf-csp-mitigation"
  lesson_title: "Lesson 11.4 Web Security: XSS, CSRF, & CSP Mitigation"
  sort_order: 1104
...
prerequisites:
  required_lesson_ids:
    - "JS-MOD11-LES03"
  required_skills:
    - "DOM Manipulation, Cookies, & Network Security"

skills_acquired:
  - "Mitigating XSS (Stored, Reflected, DOM-based) via Context-Aware Escaping"
  - "Preventing CSRF Attacks via SameSite Cookies & Anti-CSRF Tokens"
  - "Configuring Content Security Policy (CSP Headers & Nonces)"
  - "Sanitizing HTML via DOMPurify"
...
seo_and_social:
  meta_title: "Web Security: XSS Prevention, CSRF Protection & Content Security Policy (CSP)"
  meta_description: "Master Client-Side Web Security: XSS mitigation, DOMPurify HTML sanitization, CSRF prevention with SameSite cookies, and Content Security Policy (CSP)."
  keywords: ["XSS Prevention", "CSRF Protection", "Content Security Policy", "CSP Header", "DOMPurify", "Web Security"]
...
# Lesson 11.4 Web Security: XSS, CSRF, & CSP Mitigation
