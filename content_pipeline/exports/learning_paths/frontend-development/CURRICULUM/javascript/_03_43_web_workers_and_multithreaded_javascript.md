...
metadata:
  ...
  lesson_slug: "web-workers-and-multithreaded-javascript"
  lesson_title: "Lesson 12.2 Web Workers & Multithreaded JavaScript"
  sort_order: 1202
...
prerequisites:
  required_lesson_ids:
    - "JS-MOD12-LES01"
  required_skills:
    - "Event Loop & Asynchronous Execution Architecture"

skills_acquired:
  - "Multithreaded JavaScript Architecture (Web Workers)"
  - "Dedicated Workers Instantiation (`new Worker()`) & Termination"
  - "Bidirectional Message Passing (`postMessage()`, `onmessage`)"
  - "Zero-Copy Memory Sharing via `SharedArrayBuffer` & `Atomics`"
...
seo_and_social:
  meta_title: "Multithreaded JavaScript: Web Workers, postMessage & SharedArrayBuffer"
  meta_description: "Master Multithreaded JavaScript: Dedicated Web Workers, postMessage thread communication, offloading heavy CPU loops, SharedArrayBuffer and Atomics."
  keywords: ["Web Workers", "Multithreaded JavaScript", "postMessage", "SharedArrayBuffer", "Atomics", "CPU Parallelism"]
