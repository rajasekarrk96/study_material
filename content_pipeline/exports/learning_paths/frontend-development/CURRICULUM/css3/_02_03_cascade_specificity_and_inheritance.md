...
metadata:
  ...
  lesson_slug: "cascade-specificity-and-inheritance"
  lesson_title: "Lesson 1.3 Cascade, Specificity, & Inheritance"
  sort_order: 103
...
skills_acquired:
  - "The Cascade Algorithm 4-Step Resolution Tracing"
  - "Specificity Score Matrix Calculation `(Inline, ID, Class, Element)`"
  - "`!important` Mechanics & Anti-Pattern Mitigations"
  - "Inherited vs Non-Inherited Property Audit"
  - "Explicit Inheritance Keywords (`inherit`, `initial`, `unset`, `revert`, `revert-layer`)"
  - "Cascade Layers (`@layer`) Architecture & Precedence Controls"
...
seo_and_social:
  meta_title: "CSS3 Cascade Algorithm, Specificity Scores & Cascade Layers (@layer)"
  meta_description: "Master the CSS Cascade algorithm, specificity calculation matrix (0,0,0,0), !important mechanics, explicit inheritance keywords, and @layer rules."
  keywords: ["CSS Cascade", "Specificity Score", "!important", "Inheritance", "inherit unset initial", "Cascade Layers", "@layer"]
