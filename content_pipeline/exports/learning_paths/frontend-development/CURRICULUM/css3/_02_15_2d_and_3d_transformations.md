...
metadata:
  ...
  lesson_slug: "2d-and-3d-transformations"
  lesson_title: "Lesson 5.2 2D and 3D Transformations"
  sort_order: 502
...
skills_acquired:
  - "2D Transform Operations (`translate`, `scale`, `rotate`, `skew`)"
  - "3D Perspective Configuration (`perspective`, `transform-style: preserve-3d`)"
  - "3D Rotation & Translation (`rotateY`, `rotateX`, `translateZ`)"
  - "Backface Visibility Control (`backface-visibility: hidden`)"
  - "Transform Origin Pivot Adjustment (`transform-origin`)"
...
seo_and_social:
  meta_title: "CSS3 2D & 3D Transforms: preserve-3d, Perspective & Card Flipping"
  meta_description: "Master CSS3 2D/3D transforms: translate, scale, rotate, rotateY, perspective, transform-style preserve-3d, and 3D card flipping effects."
  keywords: ["CSS Transforms", "3D Transforms", "perspective", "preserve-3d", "backface-visibility", "rotateY", "CSS Card Flip"]
