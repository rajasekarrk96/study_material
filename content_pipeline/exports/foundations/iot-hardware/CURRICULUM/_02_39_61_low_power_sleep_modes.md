# 61 Low Power Sleep Modes

> **Course**: Iot Hardware | **Module**: Embedded Hardware & Peripherals | **Difficulty**: intermediate

---

In this lesson, you will master **61 Low Power Sleep Modes** in IoT Hardware Engineering.
...
```c
// C Code example for 61 Low Power Sleep Modes
