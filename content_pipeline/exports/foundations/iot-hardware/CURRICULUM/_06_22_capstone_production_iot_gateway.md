...
metadata:
  ...
  lesson_slug: "capstone-production-iot-gateway"
  lesson_title: "Lesson 10.2 Course 6 Capstone Project - Production End-to-End IoT Gateway & Dashboard"
  sort_order: 1002
...
prerequisites:
  required_lesson_ids:
    - "IOT-MOD10-LES01"
  required_skills:
    - "Full-Stack IoT Systems Engineering (ESP32, FreeRTOS, MQTT, FastAPI, WebSockets)"

skills_acquired:
  - "Constructing Production ESP32 FreeRTOS Multithreaded Firmware"
  - "Implementing Thread-Safe Hardware Sampling & Queue Decoupling"
  - "Building Production FastAPI Ingestion & Database Logging Microservices"
  - "Creating Interactive Real-Time Web Dashboards with Chart.js"
...
seo_and_social:
  meta_title: "IoT Full-Stack Capstone: ESP32 FreeRTOS, MQTT, FastAPI & Chart.js Dashboard"
  meta_description: "Build an End-to-End Production IoT System: complete ESP32 FreeRTOS edge firmware, MQTT telemetry streaming, FastAPI microservice ingestion, and real-time Chart.js web dashboard."
  keywords: ["IoT Capstone Project", "ESP32 Production Firmware", "FreeRTOS Capstone", "Full Stack IoT Project", "Chart.js Realtime Dashboard"]
...
## 6. Guided Step-by-Step Hands-On Exercise [id: exercises]
...
## 7. Industry Interview Q&A [id: interview_qa]
...
## 8. Self-Assessment Quiz [id: quiz]
...
## 9. Summary & Cheat Sheet [id: summary]
