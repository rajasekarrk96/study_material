...
metadata:
  ...
  lesson_slug: "web-workers-and-multithreading"
  lesson_title: "Lesson 7.4 Web Workers & Multithreading"
  sort_order: 704
...
prerequisites:
  required_lesson_ids:
    - "HTML5-MOD01-LES02"
  required_skills:
    - "Event Loop & Single-Threaded JavaScript Execution"

skills_acquired:
  - "Web Workers Multithreading Architecture"
  - "Dedicated Worker Creation (`new Worker('worker.js')`)"
  - "Bi-directional Messaging (`postMessage`, `onmessage`)"
  - "Terminating Workers (`worker.terminate()`)"
  - "Offloading Heavy Computations from UI Thread"
...
seo_and_social:
  meta_title: "HTML5 Web Workers & Multithreading: Offloading Heavy JS Computations"
  meta_description: "Master HTML5 Web Workers: dedicated workers, shared workers, postMessage communication, background threads, and UI main thread unblocking."
  keywords: ["Web Workers", "Multithreading HTML5", "postMessage", "onmessage", "terminate", "Dedicated Worker", "SharedWorker"]
