...
metadata:
  ...
  lesson_slug: "list-elements-and-structure"
  lesson_title: "Lesson 4.1 List Elements & Structure"
  sort_order: 401
...
prerequisites:
  required_lesson_ids:
    - "HTML5-MOD02-LES01"
  required_skills:
    - "HTML Element Classification & Nesting Rules"

skills_acquired:
  - "Ordered List (`<ol>`) Configuration (`type`, `start`, `reversed`)"
  - "Unordered List (`<ul>`) & List Item (`<li>`) Implementation"
  - "Description Lists (`<dl>`, `<dt>`, `<dd>`) for Key-Value Data"
  - "Nested List Hierarchy Construction"
  - "Semantic Navigation Menu List Markup"
...
seo_and_social:
  meta_title: "HTML Lists & Structure: Ordered, Unordered, Description & Menus"
  meta_description: "Master HTML list elements: ol, ul, li, dl, dt, dd, reversed attributes, nested list architectures, and semantic navigation menus."
  keywords: ["HTML Lists", "ol ul li", "Description List dl dt dd", "Nested Lists", "reversed attribute", "type attribute", "Navigation Menus"]
