---
id: "22_03_03"
title: "Structured Outputs (JSON, XML, Markdown)"
...
duration_minutes: 60
tags: ["structured-output", "json-mode", "schema"]
prerequisites: []
lab_required: true
---
...
## Overview of Structured Outputs (JSON, XML, Markdown)

In this lesson, you will master **Structured Outputs (JSON, XML, Markdown)** as part of Module 3: Advanced Prompt Structures in Prompt Engineering.
